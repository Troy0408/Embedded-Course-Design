...
连接 Android 手机后安装调试版 App。首次使用前，需要在 Android 系统蓝牙设置中配对 HC-05，配对码通常为 `1234` 或 `0000`。
...
- 绘制正式原理图或 PCB。
- 补充演示视频、PPT，并在报告封面填写真实姓名、学号、班级和指导教师信息。
